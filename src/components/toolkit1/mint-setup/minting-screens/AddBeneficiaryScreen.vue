  ...
  <b-card header-tag="header" footer-tag="footer" class="">
    ...
    <b-card-text class="mx-4">
      <div class="d-flex justify-content-between">
        <b-button @click="cancel()" class="w-50 py-4 mr-2" variant="outline-light">CANCEL</b-button>
        <b-button @click="addBeneficiary()" class="w-50 py-4 ml-2" variant="warning">SAVE</b-button>
      </div>
    </b-card-text>
  </b-card>
</b-card-group>
