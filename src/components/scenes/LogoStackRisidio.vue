<template>
<section>
  <Scene id="logo-stack-risidio" name="logo-stack-risidio">
    <Property name="clearColor" color="#999"></Property>
    ...
    <Asset
      ...
      @after-render$="++frames"
      src="https://test.risidio.com/gltf/3dLogos/StackRisidio/bicoinres.gltf"
      :scaling="scale.sphere"
      :position="[0, 0, 0]"
      :rotation="[0, Math.PI, 0]"></Asset>
    <!--
    <Box :position="[0, 0, 0]">
...
export default {
  ...
  computed: {
    scale () {
      const a = 2 + Math.cos(this.time * 0.00001)
      const b = 2 + Math.sin(this.time * 0.00001)
      return {
        box: [a, b, 1],
        sphere: [0.7, 0.5, 0.5]
      }
