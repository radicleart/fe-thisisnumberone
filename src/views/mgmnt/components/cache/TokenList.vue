...
<div v-else style="font-size: 0.6rem;">
  <div class="upload-preview bg-info text-white  mb-5 p-4" v-if="registry" style="font-size: 0.6rem;">
  ...
  <div class="upload-preview bg-info text-white my-5 p-4" v-if="registry" style="font-size: 0.6rem;">
    ...
    <GaiaAssetCache  style="font-size: 0.6rem;"/>
  </div>
</div>
</template>
