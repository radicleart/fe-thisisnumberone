...
<div class="mt-3" v-if="!loading">
  ...
  <div v-if="itemBeneficiaries">
    ...
    <b-row class="mb-2">
      <b-col cols="6"><span v-b-tooltip.hover="{ variant: 'danger' }" :title="itemBeneficiaries.addresses[1].valueHex">Artist</span></b-col>
      <b-col cols="2">{{itemBeneficiaries.shares[1].value}}</b-col>
      <b-col cols="2">{{itemBeneficiaries.secondaries[1].value}}</b-col>
    </b-row>
    <b-row class="mb-2">
      <b-col cols="6"><span v-b-tooltip.hover="{ variant: 'danger' }" :title="itemBeneficiaries.addresses[2].valueHex">Marketplace</span></b-col>
  ...
  <div v-else-if="beneficiaries">
    ...
    <b-row class="mb-2">
      <b-col cols="6"><span v-b-tooltip.hover="{ variant: 'danger' }" :title="beneficiaries[1].chainAddress">Artist</span></b-col>
      <b-col cols="2">{{beneficiaries[1].royalty}}</b-col>
      <b-col cols="2">{{beneficiaries[1].secondaryRoyalty}}</b-col>
    </b-row>
    <b-row class="mb-2">
      <b-col cols="6"><span v-b-tooltip.hover="{ variant: 'danger' }" :title="beneficiaries[2].chainAddress">Marketplace</span></b-col>
